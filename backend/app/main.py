...
from app.api import regime, features, health, chart_v2, orderflow, websocket, admin, zones, key_levels
...
app.include_router(key_levels.router, prefix="/api/v1", tags=["key-levels"])
